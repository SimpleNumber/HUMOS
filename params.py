...
resolutions_list = ['IT'] + [7500 * (2 ** x) for x in range(0,7)] #list of resolutions
resolutions_list_labels = ['IT'] +  [ "{0:g}k".format(7.5 * ( 2 ** x)) for x in range(0, 7)] #list of resolutions
